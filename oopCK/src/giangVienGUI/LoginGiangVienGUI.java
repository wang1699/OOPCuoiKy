					...
					table.addMouseListener(new MouseAdapter() {
						...
						public void mouseClicked(MouseEvent e) {
							if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
								...
								String maHocVien = table.getValueAt(selectedRow, 1).toString(); // cột 1 là mã
																								// học viên
								...
								int luaChon = JOptionPane.showConfirmDialog(null,
										...
										"Xác nhận điểm danh", JOptionPane.YES_NO_OPTION);
					...
					table.addMouseListener(new MouseAdapter() {
						...
						public void mouseClicked(MouseEvent e) {
							if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
								...
								String diemStr = JOptionPane.showInputDialog(null,
										"Nhập điểm cho học viên " + tenHocVien + " (" + maHocVien + "):", "Nhập điểm",
