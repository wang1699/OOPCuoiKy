...
public class KhoaHocDAO implements IKhoaHocDAO {
	...
	public List<KhoaHoc> layKhoaHocChuaDangKy(String maHocVien) {
	    List<KhoaHoc> danhSach = new ArrayList<>();

	    String sql = "SELECT * FROM KhoaHoc WHERE MaKhoaHoc NOT IN (" +
	                 "SELECT MaKhoaHoc FROM DangKy WHERE MaHocVien = ?)";
